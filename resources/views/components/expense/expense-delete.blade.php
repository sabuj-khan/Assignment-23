        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    ...
                    <button onclick="DeleteExpense()" type="button" id="confirmDelete" class="btn shadow-sm btn-danger" >Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    async function DeleteExpense(){
        ...
        showLoader();
        let response = await axios.post('/expense-delete', {id:id});
        hideLoader();
